            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        <!-- <li class="breadcrumb-item"><a href="<?= base_url('admin/role-has-permission') ?>" class="btn btn-primary">Add</a></li> -->
                    </ol>
                </div>
            </div>
        </div>
                                    ...
                                    <?php if(isset($roles) && count($roles) > 0): ?>
                                        <?php foreach ($roles as $key => $value): ?>
                                            <tr class="align-middle">
                                                ...
                                                <td>
                                                    <a href="<?= base_url('admin/role-has-permission/'.$value->id); ?>" class="btn btn-sm btn-success"><i class="bi bi-pencil"></i></a>
                                                </td> 
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php else: ?>
