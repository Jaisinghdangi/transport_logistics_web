                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        <div class="form-floating">
                                            <input type="text" name="shortname" value="<?= $country->shortname; ?>" id="shortname" class="form-control form-control-sm" placeholder="shortname Name" autocomplete="off" required=""/>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        <div class="form-floating">
                                            <input type="text" name="name" value="<?= $country->name; ?>" id="name" class="form-control form-control-sm" placeholder="Country Name" autocomplete="off" required=""/>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        <div class="form-floating">
                                            <input type="text" name="phonecode" value="<?= $country->phonecode; ?>" id="phonecode" class="form-control form-control-sm" placeholder="Phone Code" autocomplete="off" required=""/>
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <a href="<?= base_url('countries') ?>" class="btn btn-danger btn-sm" />Cancel</a>
                                    </div>
                                </div>
                            </div>
                        </form>
