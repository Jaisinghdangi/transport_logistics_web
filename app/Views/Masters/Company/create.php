                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <input type="text" name="company_code" value="<?= create_company_code(); ?>" id="company_code" class="form-control form-control-sm" autocomplete="off" required="" readonly />
                                        ...
                                        <select name="company_type" id="company_type" class="form-control" required>
                                            <?php if (isset($business_types)) : ?>
                                                ...
                                                <?php foreach ($business_types as $buss_val) : ?>
                                                    <option value="<?= $buss_val->id ?>" <?= set_value('company_type') == $buss_val->id ? 'selected' : ''; ?>><?= $buss_val->name ?></option>
                                                <?php endforeach ?>
                                            <?php endif; ?>
                                        </select>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <input type="text" name="company_name" value="<?= set_value('company_name'); ?>" id="company_name" class="form-control form-control-sm" placeholder="Company Name" autocomplete="off" required="" />
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <input type="text" name="company_mobile" value="<?= set_value('company_mobile'); ?>" id="company_mobile" class="form-control form-control-sm" placeholder="Company Mobile" minlength="10" maxlength="10" autocomplete="off" required="" />
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <input type="text" name="alternet_mobile" value="<?= set_value('alternet_mobile'); ?>" id="alternet_mobile" class="form-control form-control-sm" placeholder="Alternet Mobile" minlength="10" maxlength="10" autocomplete="off" required="" />
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <input type="email" name="company_email" value="<?= set_value('company_email'); ?>" id="company_email" class="form-control form-control-sm" placeholder="Company Email" autocomplete="off" required="" />
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        <label for="address_3" class="form-label">Address Line 3 <span class="text-danger">*</span></label>
                                        <input type="text" name="address_3" value="<?= set_value('address_3'); ?>" id="address" class="form-control form-control-sm" placeholder="Address 3" autocomplete="off" />
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <input type="text" name="pin_code" value="<?= set_value('pin_code'); ?>" id="pin_code" class="form-control form-control-sm" placeholder="Pin Code" autocomplete="off" required="" minlength="6" maxlength="6" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <input type="radio" name="gst_status" value="0" class="" autocomplete="off" onclick="switchGstValue()" required /> No
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <input type="radio" name="msme_status" value="0" class="" autocomplete="off" onclick="switchValue()" required /> No
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <input type="link" name="cin_number" value="" id="cin_number" class="form-control form-control-sm" placeholder="CIN number" autocomplete="off" />
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <input type="text" name="pan_number" onkeyup="panInputCaps()" onkeydown="panInputCaps()" value="<?= set_value('pan_number') ?>" id="pan_number" minlength="10" maxlength="10" class="form-control form-control-sm" placeholder="Pan Number" autocomplete="off" required="" />
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <input type="text" name="contact_person_email" value="<?= set_value('contact_person_email'); ?>" id="contact_person_email" class="form-control form-control-sm" placeholder="Contact Person Email" autocomplete="off" />
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <input type="text" name="contact_person_mobile" value="<?= set_value('contact_person_mobile'); ?>" id="contact_person_mobile" class="form-control form-control-sm" placeholder="Contact Person Mobile" autocomplete="off" minlength="10" maxlength="10" />
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <select name="ac_type" id="ac_type" class="form-control">
                                            ...
                                            <option value="2">Credit A/c</option>
                                        </select>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        <label for="ac_number" class="form-label">Bank A/c <span class="text-danger">*</span></label>
                                        <input type="text" name="ac_number" value="<?= set_value('ac_number'); ?>" id="ac_number" class="form-control form-control-sm" minlength="11" maxlength="16" placeholder="A/c Number" autocomplete="off" />
                                        <?php if (array_key_exists('ac_number', $errors)) : ?>
                                            <div class="text-danger"> <?= $errors['ac_number'];  ?></div>
                                        <?php endif; ?>
                                    </div>
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        <label for="bank_name" class="form-label">Name of Bank <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <input type="text" name="ifsc_code" value="<?= set_value('ifsc_code'); ?>" id="ifsc_code" minlength="11" maxlength="11" class="form-control form-control-sm" placeholder="Bank Name" autocomplete="off" />
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        <label for="pf_no" class="form-label">PF Registraion No. <span class="text-danger">*</span></label>
                                        <input type="text" name="pf_no" value="<?= set_value('pf_no'); ?>" id="pf_no" class="form-control form-control-sm" placeholder="pf Registration no" autocomplete="off" />
                                        <?php if (array_key_exists('pf_no', $errors)) : ?>
                                            <div class="text-danger"> <?= $errors['pf_no'];  ?></div>
                                        <?php endif; ?>
                                    </div>
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        <label for="esi_no" class="form-label">ESI Registraion No. <span class="text-danger">*</span></label>
                                        <input type="text" name="esi_no" value="<?= set_value('esi_no'); ?>" id="esi_no" class="form-control form-control-sm" placeholder="ESI Registration No." autocomplete="off" />
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <input type="text" name="est_no" value="<?= set_value('est_no'); ?>" id="est_no" class="form-control form-control-sm" placeholder="Establishment No" autocomplete="off" />
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <input type="link" name="iso_number" value="" id="iso_number" class="form-control form-control-sm" placeholder="ISO number" autocomplete="off" />
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <input type="text" name="pt_number" value="<?= set_value('pt_number'); ?>" id="pt_number" class="form-control form-control-sm" placeholder="PT Number" autocomplete="off" />
