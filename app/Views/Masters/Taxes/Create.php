                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">
                            <a href="<?= base_url(); ?>admin/tax">Taxes</a>
                        </li>
                    </ol>
                </div>
            </div>
                                ...
                                <div class="row">  
                                    <div class="col-md-3 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        <div class="form-floating mb-3">
                                            <input type="text" name="name" value="<?= set_value('name'); ?>" id="name" class="form-control form-control-sm" placeholder="name" autocomplete="off" required="" />
                                    ...
                                    <div class="col-md-3 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        <div class="form-floating mb-3">
                                            <input type="text" name="tax_per" value="<?= set_value('tax_per'); ?>"  onkeypress='return event.charCode >= 48 && event.charCode <= 57' onkeyup="calculate_gst($(this).val())" id="tax_per" class="form-control form-control-sm" placeholder="tax_per" autocomplete="off" required="" />
                                    ...
                                    <div class="col-md-3 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        <div class="form-floating mb-3">
                                            <input type="text" name="igst" value="<?= set_value('igst'); ?>" id="igst" class="form-control form-control-sm" placeholder="igst" autocomplete="off" required="" readonly />
                                    ...
                                    <div class="col-md-3 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        <div class="form-floating mb-3">
                                            <input type="text" name="cgst" value="<?= set_value('cgst'); ?>" id="cgst" class="form-control form-control-sm" placeholder="cgst" autocomplete="off" required="" readonly/>
                                    ...
                                    <div class="col-md-3 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        <div class="form-floating mb-3">
                                            <input type="text" name="sgst" value="<?= set_value('sgst'); ?>" id="sgst" class="form-control form-control-sm" placeholder="sgst" autocomplete="off" required="" readonly/>
                                    ...
                                    <div class="col-md-3 col-sm-4 col-lg-4 col-xl-4 col-xxl-4"> 
                                        <div class="form-floating mb-3 ">
                                            <input type="text" name="cess" value="<?= set_value('cess'); ?>" id="cess" class="form-control form-control-sm" placeholder="cess" autocomplete="off" required="" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/>
