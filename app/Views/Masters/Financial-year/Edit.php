                                ...
                                <div class="row"> 
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        <div class="form-floating">
                                            <input type="date" name="start_date" value="<?= $year->starting_year; ?>" id="start_date" class="form-control form-control-sm" placeholder="start_date" autocomplete="off" required="" />
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        <div class="form-floating">
                                            <input type="date" name="end_date" value="<?= $year->ending_year; ?>" id="end_date" class="form-control form-control-sm" placeholder="end_date" autocomplete="off" required="" />
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        <div class="form-floating">
                                            <input type="text" name="year" value="<?= $year->year; ?>" id="year" class="form-control form-control-sm" minlength="6" maxlength="7" placeholder="year" autocomplete="off" required="" />
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <a href="<?= base_url('admin/FinancialYears') ?>" class="btn btn-danger btn-sm">Cancel</a>
                                    </div>
                                </div>
                            </div>
                        </form>
