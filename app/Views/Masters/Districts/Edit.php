                        ...
                        <form method="POST">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    ?>  
                                    <?php 
                                        echo render_view('Components/countries', ['required'=>true,'data'=>'',  'label'=>'State', 'name'=>'state_id', 'error'=>array_key_exists('state_id', $errors) ? $errors['state_id'] : '', 'value'=>set_value('state_id'), 'attrs'=>['data'=>$district->state_id]  ]); 
                                    ?>
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4"> 
                                        <label for="name">City Name <span class="text-danger">*</span></label>
                                        <input type="text" name="name" value="<?= $district->name; ?>" id="name" class="form-control form-control-sm" placeholder="City Name" autocomplete="off" required=""/>
