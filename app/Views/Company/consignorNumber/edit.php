                    ...
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            <div class="card-title">
                                ...
                                Update  Company Consignor Number
                            ...
                            <div class="card-body"> 
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4"> 
                                        ...
                                        <input type="text" name="start_number" value="<?=$consign->start_number;?>" id="start_number" class="form-control form-control-sm"  required />
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4"> 
                                        ...
                                        <input type="text" name="end_number" value="<?=$consign->end_number;?>" id="end_number" class="form-control form-control-sm"  required />
                                        <span class="errormsg" style="font-size: 11px;color: red;"></span>

                                    </div>
                                    <input type="hidden" name="comp_id" value="<?=$consign->comp_id;?>" id="comp_id" class="form-control form-control-sm"  />
                                    <input type="hidden" name="user_id" value="<?=$consign->user_id;?>" id="user_id" class="form-control form-control-sm"  />
...
<script> 
   ...
   var lastEndValue = parseInt(<?= ($ConsignNumberValue) ? $ConsignNumberValue->end_number : 0; ?>);
   var nextStartValue = parseInt(<?= ($ConsignNumberValExtra) ?  $ConsignNumberValExtra->start_number: 0; ?>);
...
$(document).on("change", "#end_number", function() {
 ...
 // Check for duplicates and validate against the range
     if (end_value > start_value) {
         $(".errormsg").text('');
         if(nextStartValue !='' && nextStartValue !='0'){
     if(end_value < nextStartValue){
        $(".errormsg").text('');

     }else{
        $(".errormsg").text('End Number Must we Lestt then Next Company Consignor Start Number '+nextStartValue);
        $(this).val('');
     }}
     }else{
