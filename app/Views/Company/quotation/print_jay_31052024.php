                        ...
                        <div class="side-detail">
                             <table style="border:0px">
                                <tr>
                                    ...
                                    <td style="border:1px solid #000; border-right: 0;"><span class="invoice-no"><?= $result->quotation_number ?> </span></td>
                                </tr>
                                <tr>
                                    <td class="text-right"><b>Date</b></td>
                                    <td style="border:1px solid #000; border-right: 0;"><span><?= $result->quotation_date ?></span></td>
                                </tr>
                                <tr>
                                    <td class="text-right"><b>PLACE OF SUPPLY</b></td>
                                    <td style="border:1px solid #000; border-right: 0;"><span><?= get_title('pincodes', ['id' => $result->delivery_address_id], 'StateName') ?> </span></td>
                                </tr>
                            </table>
                            </div>
                        </td>
            ...
            <tr>
                <td style="padding:0px;">
                    <table style="border: 0;">
                        <tr>
                            <td style="text-align:center; border:1px solid #000; width:48%;border-left:0;"><h5>Consignor Details</h5></td>
                            <td rowspan="2" style="width:4%;"></td>
                            <td style="text-align:center; border:1px solid #000;width:48%; border-right:0px;"><h5>Delivery Address</h5></td>
                        </tr>
                        <tr>
...
?>
                                <tr>
                                 ...
                                 <?php   if (isset($dimension->amt[$key])) {
                                       $amount = $dimension->amt[$key];
                           echo "<td colspan='2' style='border:1px solid #000; text-align:center; border-right: 0;'>$amount</td>";
                         } else {
                     echo "<td colspan='2' style='border:1px solid #000; text-align:center; border-right: 0;'></td>";
                            } ?>
                                </tr>
                        <?php }
                        } ?>
                        <tr>
                            ...
                            <td colspan="2" style="border:1px solid #000;width:10%; text-align:center;border-right: 0;"><?= number_format($result->amount) ?></td>
                        </tr>
                        <!-- <tr>
                            <td colspan="2"></td>
                            <td></td>
