            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-outline card-primary">
                        ...
                        <form action="<?=base_url('company/editnew-quotation/' . $editid);?>" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4">
                                        <label for="name" class="form-label">Quotation No<span class="text-danger">*</span></label>
                                        <input type="text" name="quotation_number" class="form-control" id="quotation_number" value="<?= $quotation -> quotation_number; ?>" readonly>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4">
                                        ...
                                        <input type="date" name="quotation_date" class="form-control" id="quotation_date" value="<?= $quotation -> quotation_date ; ?>" min="<?= date('Y-m-d') ?>">
                                    ...
                                    <?php
                                    echo render_view('Components/countries', ['data' => $consignor, 'required' => true, 'label' => 'Consignor', 'name' => 'consignor', 'error' => array_key_exists('consignor', $errors) ? $errors['consignor'] : '', 'value' =>$quotation -> consignor , 'classes' => 'select2']);
                                    ?>

                                    <?php
                                    //   echo render_view('Components/countries', ['data' => $consignee, 'required'=>true, 'label'=>'Consignee', 'name'=>'consignee', 'error'=>array_key_exists('consignee', $errors) ? $errors['consignee'] : '', 'value'=>'', 'classes'=> 'select2']);  
                                    ?>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="consignor_local_address" class="form-control" id="consignor_local_address" placeholder="Consignor Local Address" required><?= $quotation -> consignor_local_address ; ?></textarea>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                            ...
                                            <input type="text" id="pincode" name="pincode" onchange="getPincodeAddress()" class="form-control" placeholder="Search by Pincode" required value="<?=$quotation ->pincode ; ?>"/>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12 col-xxl-12">
                                            ...
                                            <textarea name="local_delivery_address" id="local_delivery_address" class="form-control" placeholder="Full Address" required><?=$quotation ->local_delivery_address ;?></textarea>
                                    ...
                                    <div class="row mt-3">  
                                        <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4">
                                            ...
                                            <input type="number" name="amount" class="form-control" id="amount" value="<?=$quotation ->amount; ?>" readonly>
                                        </div> 
                                        <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4">
                                        ...
                                        <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 d-none">
                                            ...
                                            <input type="date" name="estmate_deliv_dt" id="estmate_deliv_dt" value="<?= $quotation -> estmate_deliv_dt ; ?>" class="form-control" >
                                        </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12 col-xxl-12">
                                            ...
                                            <textarea name="remark" class="form-control" id="remark" placeholder="remark"><?=$quotation ->remark; ?></textarea>
                                        </div>
                                    </div>
...
$('#consignor_local_address').val(consignorLocalAdd);
    ...
    var quatationId =<?= $quatationid;?>;

    $(document).ready(function() {
        var inputText = $('#remark').val().toLowerCase();
        var words = inputText.split(' ');
        var capitalizedWords = words.map(function(word) {
            return word.charAt(0).toUpperCase() + word.slice(1);
        });
        var capitalizedText = capitalizedWords.join(' ');
        $('#remark').val(capitalizedText);
    });
...
$('#consignor_local_address').val(consignorLocalAdd);
    ...
    $(document).ready(() =>{
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (result.status == '1') {
                    result.result.forEach((element) => {
                        var selectedofc = (element.Id == postofcValue) ? 'selected' : '';
                        post_office_html += `<option value=` + element.Id + ` `+selectedofc+`>` + element.OfficeName + `</option>`;
    ...
    //   $('#length_unit_'+i).val(dimentiondata.length_unit[i]);
      ...
      var length = '<select name="dimension[length_unit][]" class="unitDropdown" required>';
      ...
      length += '</select>';
        ...
        var height = '<select name="dimension[height_unit][]" class="unitDropdown" required>';
        ...
        var width = '<select name="dimension[width_unit][]" class="unitDropdown" required>';
        ...
        var weight = '<select name="dimension[weight_unit][]" class="unitDropdown" required>';
        ...
        cell2.innerHTML = `<input type="text" name="dimension[length][]" class="form-control" id="length" placeholder="length" style="width:70px;float:left;margin-right: 5px;" value="`+dimentiondata.length[i]+`" required>`+ length;
        cell4.innerHTML = `<input type="text" name="dimension[height][]" class="form-control" id="height" placeholder="height" style="width:70px;float:left;margin-right: 5px;" value="`+dimentiondata.height[i]+`" required>`+height;
        cell3.innerHTML = `<input type="text" name="dimension[width][]" class="form-control" id="width" placeholder="width" style="width:70px;float:left;margin-right: 5px;" value="`+dimentiondata.width[i]+`" required>`+width;
        cell5.innerHTML = `<input type="text" name="dimension[weight][]" value="`+dimentiondata.weight[i]+`" class="form-control" id="weight" placeholder="Weight" style="width:70px;float:left;margin-right: 5px;" required>`+weight;
        cell6.innerHTML = `<input type="number" name="dimension[amt][]" value="`+ (dimentiondata.amt && dimentiondata.amt[i] !== undefined ? dimentiondata.amt[i] : '') +`" class="form-control amountDimention" id="amt" placeholder="Amount" style="width:95px;float:left;" required>`;
        if (table.rows.length == 1) {
            cell7.innerHTML += "<button type='button' class='add-btn addcls' onclick='addRowNew()'>Add</button>";
        } else {
    ...
    function addRowNew() {
        ...
        cell1.innerHTML = table.rows.length; 
        cell2.innerHTML = `<input type="text" name="dimension[length][]" class="form-control" id="length" placeholder="length" style="width:70px;float:left;margin-right: 5px;" value="" required><select name="dimension[length_unit][]"  class="unitDropdown" required >'<?= dimension_unit_html() ?>'</select>`;
        cell4.innerHTML = `<input type="text" name="dimension[height][]" class="form-control" id="height" placeholder="height" style="width:70px;float:left;margin-right: 5px;" required> <select name="dimension[height_unit][]"  class="unitDropdown" required >'<?= dimension_unit_html() ?>'</select>`;
        cell3.innerHTML = `<input type="text" name="dimension[width][]" class="form-control" id="width" placeholder="width" style="width:70px;float:left;margin-right: 5px;" required> <select name="dimension[width_unit][]"  class="unitDropdown" required >'<?= dimension_unit_html() ?>'</select>`;
        cell5.innerHTML = `<input type="text" name="dimension[weight][]" class="form-control" id="weight" placeholder="Weight" style="width:70px;float:left;margin-right: 5px;" required><select name="dimension[weight_unit][]"  class="unitDropdown" required >'<?= weight_unit_html() ?>'</select>`;
