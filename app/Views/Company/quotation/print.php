        ...
        <table class="my-table">
                        ...
                        <div class="side-detail">
                             <table style="border:0px">
                                <tr>
                                    ...
                                    <td style="border:1px solid #000; border-right: 0;background: #ea7935;font-weight: bold;"><span class="invoice-no" style="color: #fff;"><?= $result->quotation_number ?> </span></td>
                                </tr>
                                <tr>
                                    <td class="text-right"><b>Date</b></td>
                                    <td style="border:1px solid #000; border-right: 0;"><span><?= dispalyDate($result->quotation_date) ?></span></td>
                                </tr>
                                <tr>
                                    <td class="text-right"><b>From</b></td>
                                    <td style="border:1px solid #000; border-right: 0;"><span><?= get_title('cities', ['id' => $result->district], 'name') ?> </span></td>
                                </tr>
                                 <tr>
                                    <td class="text-right"><b>To</b></td>
                                    <td style="border:1px solid #000; border-right: 0;"><span><?= get_title('pincodes', ['id' => $result->delivery_address_id], 'District') ?> </span></td>
                                </tr>
                            </table>
                            </div>
                        </td>
            ...
            <tr>
                <td style="padding:0px;">
                    <table style="border: 0;">
                        <tr>
                            <td style="text-align:center; border:1px solid #000; width:48%;border-left:0; color:#fff!important;background-color:#00297a"><h5>Consignor Details</h5></td>
                            <td rowspan="2" style="width:4%;"></td>
                            <td style="text-align:center; border:1px solid #000;width:48%; border-right:0px; color:#fff!important;background-color:#00297a"><h5>Delivery Address</h5></td>
                        </tr>
                        <tr>
                            <td style=" border:1px solid #000; border-bottom:0px; border-left:0;">
                            ...
                            <td style=" border:1px solid #000; vertical-align:top;border-bottom:0px; border-right:0px;">
                                 <?php $consignee_address_data= quatation_delivery_address($result); ?>
            ...
            <tr>
                <td style="padding:0px;">
                    ...
                    ?>
                    <table style="border: 0px solid #000;border-top: 1px solid #000;">
                        <tr>
                            <td colspan="6"><h5>Product Dimention</h5></td>
                        </tr>
                            <tr>
                            <th colspan="2" style=" border:1px solid #000; text-align:center; width:20%;border-left: 0;">S NO.</th>
                            ...
                            <th colspan="2" style=" border:1px solid #000; text-align:center; width:20%;border-right: 0;">Amount</th>
                        </tr>
                        <?php
                        $totalweight = 0;
                        ...
                        ?>
                                <tr>
                                    <td colspan="2" style=" border:1px solid #000; text-align:center;border-left: 0;"><?= $key + 1; ?></td>
                                    <td style=" border:1px solid #000; text-align:center;"><?= $value ?> <?= $dimension->width_unit[$key] ?></td>
                                    <td style=" border:1px solid #000; text-align:center;"><?= $dimension->height[$key] ?> <?= $dimension->height_unit[$key] ?></td>
                                    <td style=" border:1px solid #000; text-align:center;"><?= $dimension->length[$key] ?> <?= $dimension->length_unit[$key] ?></td>
                                    <td style=" border:1px solid #000; text-align:center;"><?= $dimension->weight[$key] . ' ' . $dimension->weight_unit[$key]; ?></td>
                                    <?php if (isset($dimension->amt[$key])) {
                                        $amount = number_format($dimension->amt[$key]);
                                        echo "<td colspan='2' style='border:1px solid #000; text-align:right; border-right: 0;'> $amount</td>";
                                    } else {
                                        echo "<td colspan='2' style='border:1px solid #000; text-align:right; border-right: 0;'></td>";
                                    } ?>
                                </tr>
                        <?php }
                        } ?>
                        <tr>
                            <td colspan="5" style="border:1px solid #000; width:12%;  text-align:right;border-left: 0;"><b>Total</b></td>
                            <td style="border:1px solid #000;width:8%; text-align:center"><?= $totalweight ?> Kg</td>
                            <td colspan="2" style="border:1px solid #000;width:10%; text-align:right;border-right: 0;"><?= number_format($result->amount) ?></td>
                        </tr>
                        <!-- <tr>
                            <td colspan="2"></td>
                            <td></td>
            ...
            <tr>
                ...
                <td style="text-align:center; color:#fff!important;background-color:#00297a;font-weight:bold">Terms and Conditions</td>
            <tr>
            <tr>
                <td>
                    <ul class="text-left conditions mb-0 p-0">
