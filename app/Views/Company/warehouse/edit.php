                            ...
                            <div class="card-body"> 
                                <div class="row"> 
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <input type="text" name="name" value="<?= $warehouse->name; ?>" id="name" class="form-control form-control-sm" placeholder="Warehouse Name" autocomplete="off" required=""/>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4 mt-2">
                                        ...
                                        <input type="text" name="location" value="<?= $warehouse->location; ?>" id="location" class="form-control form-control-sm" placeholder="Location" autocomplete="off" />
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <input type="text" name="mobile" value="<?= $warehouse->mobile; ?>" id="mobile" class="form-control form-control-sm" placeholder="Mobile" minlength="10" maxlength="10" autocomplete="off" />
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4 mt-2">
                                        ...
                                        <input type="email" name="email" value="<?= $warehouse->email; ?>" id="email" class="form-control form-control-sm" placeholder="Email" autocomplete="off" />
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4 mt-2">
                                        ...
                                        <input type="text" name="remark" value="<?= $warehouse->remark; ?>" id="remark" class="form-control form-control-sm" placeholder="Remark" autocomplete="off" />
