                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <select name="series_type" id="series_type" class="form-control" required>
                                            ...
                                            <?php foreach ($series as $series_key => $series_val) : ?>
                                                <option value="<?= $series_val->id ?>" <?= set_value('series_type') == $series_val->id ? 'selected' : '' ?>><?= $series_val->name ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-4">
                                                <select name="financial_year_pos" id="financial_year_pos" class="form-control">
                                                    <option value="1" <?= set_value('start_point_pos') == 1 ? 'selected' : '' ?>>1</option>
                                                    <option value="2" <?= set_value('start_point_pos') == 2 ? 'selected' : '' ?>>2</option>
                                                    <option value="3" <?= set_value('start_point_pos') == 3 ? 'selected' : '' ?>>3</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <div class="row">
                                            <div class="col-8">
                                                <input type="text" name="prefix" id="prefix" placeholder="Prefix" value="<?= set_value('prefix') ?>" class="form-control" required>
                                            ...
                                            <div class="col-4">
                                                <select name="prefix_pos" id="prefix_pos" class="form-control" required>
                                                    <option value="1" <?= set_value('prefix_pos') == 1 ? 'selected' : '' ?>>1</option>
                                                    <option value="2" <?= set_value('prefix_pos') == 2 ? 'selected' : '' ?>>2</option>
                                                    <option value="3" <?= set_value('prefix_pos') == 3 ? 'selected' : '' ?>>3</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <div class="row">
                                            <div class="col-8">
                                                <input type="text" name="start_point" id="start_point" placeholder="00001" value="<?= set_value('start_point') ?>" class="form-control" required>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <input type="text" name="symbl" id="symbl" placeholder="Ex: / " class="form-control" value="<?= set_value('symbl') ?>">
