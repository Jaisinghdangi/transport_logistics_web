                            ...
                            <div class="card-body"> 
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4"> 
                                        <label for="consignor_code" class="form-label">Consignee Code <span class="text-danger">*</span></label>
                                        <input type="text" name="consignor_code" value="<?= $consign->consignor_code ?>" id="consignor_code" class="form-control form-control-sm" autocomplete="off" required="" readonly />
                                        ...
                                        <select name="consignor_type" id="consignor_type" class="form-control" required>
                                            <?php if(isset($business_types)): ?>
                                                ...
                                                <?php foreach($business_types as $buss_val): ?>
                                                    <option value="<?= $buss_val->id ?>" <?= $consign->consignor_type == $buss_val->id ? 'selected' : '' ?> ><?= $buss_val->name ?></option>
                                                <?php endforeach ?>
                                            <?php endif; ?>
                                        </select>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <input type="text" name="name" value="<?= set_value('name',$consign->name); ?>" id="name" class="form-control" placeholder="Consignor Name" autocomplete="off" required="" /> 
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <input type="email" name="email" value="<?= set_value('email',$consign->email); ?>" id="email" class="form-control form-control-sm" placeholder="Email" autocomplete="off" required="" />
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <input type="text" name="mobile" value="<?= set_value('mobile',$consign->mobile) ?>" id="mobile" class="form-control form-control-sm" minlength="10" maxlength="10" placeholder="Mobile" autocomplete="off" required=""   />
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <input type="text" name="alternet_mobile" value="<?= set_value('alternet_mobile',$consign->alternet_mobile); ?>" id="alternet_mobile" minlength="10"  maxlength="10" class="form-control form-control-sm" placeholder="Alternet Mobile" autocomplete="off" />
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <select name="country" id="country" class="form-control select2" required>
                                            ...
                                            <?php foreach($countries as $country): ?>
                                                <option value="<?= $country->id ?>" <?= $country->id  == $consign->country ? 'selected' : '' ?>><?= $country->name ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4"> 
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <input type="radio" name="gst_status" value="1" <?= set_value('gst_status',$consign->gst_status) == 1 ? 'checked' : ''; ?> class="" autocomplete="off" onclick="switchGstValue()" required/> Yes
                                            </div>
                                            <div class="col-6">
                                                <input type="radio" name="gst_status" value="0"  <?= set_value('gst_status',$consign->gst_status) == 0 ? 'checked' : ''; ?>  class="" autocomplete="off" onclick="switchGstValue()" required/> No
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4"> 
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <input type="radio" name="msme_status" value="1" <?= set_value('msme_status',$consign->msme_status) == 1 ? 'checked' : ''; ?> class="" autocomplete="off" onclick="switchValue()" required/> Yes
                                            </div>
                                            <div class="col-6">
                                                <input type="radio" name="msme_status" value="0" <?= set_value('msme_status',$consign->msme_status) == 0 ? 'checked' : ''; ?>  class="" autocomplete="off" onclick="switchValue()" required/> No
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row"> 
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4 d-none"> 
                                        ...
                                        <input type="text" name="iec_number" value="<?= set_value('iec_number',$consign->iec_number); ?>" id="iec_number" class="form-control form-control-sm" placeholder="IEC Number" autocomplete="off" />
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4"> 
                                        ...
                                        <input type="link" name="company_website" value="<?= set_value('company_website',$consign->company_website) ?>" id="company_website" class="form-control form-control-sm" placeholder="Company Website" autocomplete="off" />
                                ...
                                <div class="row"> 
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4"> 
                                        ...
                                        <select name="ac_type" id="ac_type" class="form-control">
                                            ...
                                            <option value="1" <?= set_value('ac_type',$consign->ac_type) == 1 ? 'selected' : '' ?> >Saving A/c</option>
                                            <option value="2"  <?= set_value('ac_type',$consign->ac_type) == 2 ? 'selected' : '' ?>>Current A/c</option>
                                            <option value="3"  <?= set_value('ac_type',$consign->ac_type) == 3 ? 'selected' : '' ?>>Credit A/c</option>
                                        </select>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4"> 
                                        ...
                                        <input type="text" name="ifsc_code" value="<?= set_value('ifsc_code',$consign->ifsc_code); ?>" id="ifsc_code" minlength="11"  maxlength="11"  class="form-control form-control-sm" placeholder="IFSC Code" autocomplete="off" />
