                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-outline card-primary">
                            ...
                            <form action="<?= base_url('save-Booking') ?>" method="POST" enctype="multipart/form-data">
                                <?php $booking_number = getVoucherNumber('Booking'); ?>
                                    ...
                                    <div class="container-main py-1">
                                        ...
                                        <div class="row my-3">
                                            <div class="col-sm-6">
                                                <div class="inside-container-fluid inside-container-left">
                                                    ...
                                                    <table class="table table-address mb-0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php  echo $result->consinor_address; ?>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-bold" style="border-bottom:0px;">GSTIN:</td>
                                                ...
                                                <div class="inside-container-fluid inside-container-left" style="border-top:0px;">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="inside-container-fluid inside-container-right" style="border-bottom:0px">
                                                    ...
                                                    <table class="table table-address mb-0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="number" class="calculate_booking_amount" id="rto_fine" name="rto_fine" value="0" style="border: 0px;text-align: right;" /></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-bold">Advance, if any</td>
                                                            <td><input type="number" class="" id="advance_pay" name="advance_pay" value="0" style="border: 0px;text-align: right;" /></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-bold">Statical Charge (Rs. 80 for AMS)</td>
                                                            <td><input type="number" class="calculate_booking_amount" id="statical_charge" name="statical_charge" value="0" style="border: 0px;text-align: right;" /></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-bold">Detention Charges at Loading Point</td>
                                                            <td><input type="number" class="calculate_booking_amount" id="detention_charge_loading" name="detention_charge_loading" value="0" style="border: 0px;text-align: right;" /></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-bold">Detention Charges at Unloading Point</td>
                                                            <td><input type="number" class="calculate_booking_amount" id="detention_charge_unloading" name="detention_charge_unloading" value="0" style="border: 0px;text-align: right;" /></td>
                                                        </tr>
                                                        <tr class="d-none" >
                                                            <td class="text-bold">Total Payable</td>
                                                            <td><input type="number" class="calculate_booking_amount" id="total_payable" name="total_payable" value="<?= $result ? $result->amount : 0; ?>" style="border: 0px;text-align: right;" readonly /></td>
                                                        </tr>
                                                        <tr class="d-none" >
                                                            <td class="text-bold">CGST 2.5%</td>
                                                            <td><input type="number" class="calculate_booking_amount" id="total_cgst" name="total_cgst" value="0" style="border: 0px;text-align: right;" /></td>
                                                        </tr>
                                                        <tr class="d-none" >
                                                            <td class="text-bold">SGST 2.5%</td>
                                                            <td><input type="number" class="calculate_booking_amount" id="total_sgst" name="total_sgst" value="0" style="border: 0px;text-align: right;" /></td>
                                                        </tr>
                                                        <tr class="d-none" >
                                                            <td class="text-bold">IGST 5.5%</td>
                                                            <td><input type="number" class="calculate_booking_amount" id="total_igst" name="total_igst" value="0" style="border: 0px;text-align: right;" /></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-bold">Total</td>
                                                            <td><input type="number" id="net_amount" name="net_amount" value="<?= $result ? $result->amount : 0; ?>" style="border: 0px;text-align: right;" readonly /></td>
                                                        </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <select id="broker_id" name="broker_id" class="form-control" style="border: 0px;" required>
                                                                        ...
                                                                        ?>
                                                                            <option value="<?= $value->id ?>"><?= ucfirst($value->name) . ' ( ' . $value->mobile . ' )'; ?></option>
                                                                        <?php } ?>
                                                                    </select>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><select id="vehicle_type" name="vehicle_type" class="form-control" style="border:0px;">
                                                                       ...
                                                                       <?php foreach ($VehicalType as $key => $value) { ?>
                                                                            <option value="<?= $value->id ?>"><?= $value->vehical_type ?></option>
                                                                        <?php } ?>
                                                                    </select></td>
                                                            </tr>
                                                            <tr>
                                                    ...
                                                    <div class="inside-container-fluid inside-container-left mt-2 border-start border-end-0" style="border-color: #000 !important;">
                                                        ...
                                                        <table class="table table-address mb-0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input type="number" class="broker_blance_payable" id="total_broker_amount" name="total_broker_amount" value="" style="border: 0px;text-align: right;" placeholder="(Amount in Rs.)" required /></td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-bold border-end">RTO fine:</td>
                                                                <td><input type="number" class="broker_blance_payable" id="broker_rto_fine" name="broker_rto_fine" value="0" style="border: 0px;text-align: right;" /></td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-bold border-end">Detention Charges, if any:</td>
                                                                <td><input type="number" class="broker_blance_payable" id="detention_charges" name="detention_charges" value="0" style="border: 0px;text-align: right;" /></td>
                                                            </tr>


                                                            <tr>
                                                                <td class="text-bold border-end text-danger">Late delivery Charges:</td>
                                                                <td><input type="number" class="broker_blance_payable" id="late_delivery_charges" name="late_delivery_charges" value="0" style="border: 0px;text-align: right;" /></td>
                                                            </tr>

                                                            <tr>
                                                                <td class="text-bold border-end text-danger">Other Deduction Charges:</td>
                                                                <td><input type="number" class="broker_blance_payable" id="other_deduction_charges" name="other_deduction_charges" value="0" style="border: 0px;text-align: right;" /></td>
                                                            </tr>

                                                            <tr>
                                                                <td class="text-bold border-end" style="background:#f3f3f3;"><b>Total Lorry Hire Charges:</b></td>
                                                                <td style="background:#f3f3f3;"><input type="number" id="total_lorry_hire_charge" name="total_lorry_hire_charge" value="0" style="border: 0px;text-align: right;background:#f3f3f3" readonly=""></td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input type="number" id="advance" name="advance" value="0" class="total_advance_paid" style="border: 0px;text-align: right;" /></td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-bold border-end" style="color:#3daa25">Mamul Charges (A):</td>
                                                                <td><input type="number" id="mamul_chargesa" name="mamul_chargesa" value="0" class="total_advance_paid" style="border: 0px;text-align: right;" /></td>
                                                            </tr>

                                                            <tr>
                                                                <td class="text-bold border-end" style="color:#3daa25">Advance Payable:</td>
                                                                <td><input type="number" id="advance_payable" name="advance_payable" value="0" style="border: 0px;text-align: right;" readonly /></td>
                                                            </tr>

                                                            <tr>
                                                                <td class="text-bold border-end" style="color:#3daa25">Advance Paid:</td>
                                                                <td><input type="number" id="advance_paid" name="advance_paid" value="0" class="total_advance_paid" style="border: 0px;text-align: right;" /></td>
                                                            </tr>


                                                            <tr>
                                                                <td class="text-bold border-end" style="color:#3daa25">Balance:</td>
                                                                <td><input type="number" id="total_balance" name="total_balance" value="0" style="border: 0px;text-align: right;" readonly /></td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input type="number" id="mamul_chargesb" name="mamul_chargesb" value="0" class="balance_payable" style="border: 0px;text-align: right;" /></td>
                                                            </tr>

                                                            <tr>
                                                                <td class="text-bold border-end " style="background:#f3f3f3;color:#3daa25"><b>Balance Payabe:</b></td>
                                                                <td style="background:#f3f3f3;"><input type="number" id="balance_payable" name="balance_payable" value="0" style="border: 0px;text-align: right;color:#3daa25;background:#f3f3f3;" readonly /></td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-bold border-end ">Balance Paid:</td>
                                                                <td><input type="number" id="total_balance_payable" name="balance_paid" value="0" class="balance_payable" style="border: 0px;text-align: right;font-weight: 500;" /></td>
                                                            </tr>
