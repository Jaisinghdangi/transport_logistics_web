    ...
    <div style="background-color:#fff;">
        ...
        <body>
            <div class="app-content">
                <form action="<?= base_url('edit-vehical/'.$updateid) ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="container-fluid mx-0">
                        <div class="container-main py-1">
                                    ...
                                    <div class="inside-container-fluid inside-container-left pb-2">
                                        <table class="table table-bordered">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <select id="consignee_id" name="consignee_id" class="form-control" style="border: 0px;" required>
                                                                        ...
                                                                        ?>
                                                                            <option value="<?= $value->id ?>" <?= $value->id == $booking->consignee_id ? 'selected' : ''; ?>><?= ucfirst($value->name) . ' (' .$value->nickname.')' . ' ( ' . $value->mobile . ' )'; ?></option>
                                                                        <?php } ?>
                                                                    </select>
                                            ...
                                            <tfoot id="consign_numbers">
                                                ...
                                                <?php $kee = 0; foreach ($bookingConsignNum as $value) {
                                                    if ($value->booking_id == $booking->id) {
                                                        ++$kee;
                                                ?>
                                                        <tr>
                                                            <td>
                                                                <div class="input-container">
                                                                    <input type="number" name="consign_number[]" id="consign_number" value="<?= $value->consignment_number ?>" class="consign_number" placeholder="Enter Consign No." required="">
                                                                    <span class="errormsg" style="font-size: 10px;color: red;"></span>
                                                                </div>

                                                            </td>
                                                            <td colspan="2">
                                                            <textarea rows="1" cols="4" name="service_description[]" id="service_description" class="form-control" placeholder="ENTER DESCRIPTION OF GOODS/SERVICES" style="width:40% !important;display: inline;"><?= $value->service_description ?></textarea>
                          ...
                          <input type="date" id="eway_bill_expire" value="<?= $value->eway_bill_expire; ?>" name="eway_bill_expire[]" class="form-control" placeholder="Eway Expire" onfocus="(this.type='date')" style="width:19%;display: inline;vertical-align: top;" required>
                                                            </td>
                                                         <?php if($kee != 1){ ?><td><button class='remove-btn' onclick='removeRow(this)'><i class="bi bi-trash"></i></button></td> <?php }  ?>
                                                        </tr>
                                                <?php }
                                                } ?>
                                            </tfoot>
