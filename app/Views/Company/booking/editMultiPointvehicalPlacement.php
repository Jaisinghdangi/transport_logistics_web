    ...
    <div style="background-color:#fff;">
        ...
        <body>
            <div class="app-content">
                <form action="<?= base_url('edit-multipointVehical/'.$updateid) ?>" method="POST" enctype="multipart/form-data" id="yourFormId">
                    ...
                    <div class="container-fluid mx-0">
                        <div class="container-main py-1">
                            ...
                            <div class="row mt-3">
                            <?php 
           $maincount=count($MultiBookingVehical);   
foreach ($MultiBookingVehical as $key1 => $multivalue) {
    // if ($value11->booking_id== $multivalue->booking_id && $value11->consignee_id == $multivalue->consignee_id) { 
                                                ?>
                                <div class="col-sm-12"  id="<?php if($key1 == ($maincount-1)){?>appendconsignee<?php } ?>">
                                    <div class="inside-container-fluid inside-container-left pb-2 remove-box">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="text-center" style="width:17.66666667%;">
                                                        <p><input type="date" name="consign_date[]" id="consign_date" class="form-control" value="<?= $multivalue->consign_date; ?>" placeholder="Consign No" required /></p>
                                                        <?php if($key1=='0'){ ?>
                                                    ...
                                                    <td>
                                                        <table class="table table-address mb-0">
                                                            <tr>
                                                                ...
                                                                <td><?php  if($key1=='0') {if (!empty($consignor_details)) {
                ...
                <input type="hidden" name="consignorr_id[]" class="consignorr_idn" value="<?=$consignor_details->id; ?>">
                                ...
                                <select name="consignorr_id[]" class="consignorr_idn form-control" style="border: 0px;" required>
                                                                    <option value="">Select Consignor</option>
                                                                    <?php foreach ($consignorr as $key => $value) {
                                                                    ?>
                                                                        <option value="<?= $value->id ?>" <?= $value->id == $multivalue->consignor_id ? 'selected' : ''; ?>><?= ucfirst($value->name) . ' (' .$value->nickname.')' .' ( '.$value->mobile . ' )'; ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <select id="consignee_id" name="consignee_id[]" class="form-control" style="border: 0px;" required>
                                                                        ...
                                                                        ?>
                                                                            <option value="<?= $value->id ?>" <?= $value->id == $multivalue->consignee_id ? 'selected' : ''; ?>><?= ucfirst($value->name) . ' (' .$value->nickname.')' . ' ( ' . $value->mobile . ' )'; ?></option>
                                                                        <?php } ?>
                                                                    </select>
                    ...
                    <tfoot <?php if($key1 == '0'){ ?>id="consign_numbers"<?php } if($key1 != '0'){ ?>class="consign_numbers"<?php } ?> >
                                                <?php 
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="input-container">
                                                                    <input type="number" name="consign_number[]" id="consign_number" value="<?= $value->consignment_number ?>" class="consign_number form-control" placeholder="Enter Consign No." required="">
                                                                    <input type="hidden" name="consign_consignee_id[]" id="consign_consignee_id" value="<?= $value->consignee_id ?>" class="consign_consignee_id"/>
                                                                   <input type="hidden" name="consign_consignor_id[]" id="consign_consignor_id" value="<?= $value->consignor_id ?>" class="consign_consignor_id"/>
                                                            ...
                                                            <td colspan="2">
                                                                ...
                                                                <textarea rows="1" cols="6" name="service_description[]" id="service_description" class="form-control" placeholder="ENTER DESCRIPTION OF GOODS/SERVICES" style="width:40%;display: inline;"><?= $value->service_description ?></textarea>
                                                                <input type="text" id="eway_bill" name="eway_bill[]" class="form-control" placeholder="Eway Bill" style="width:19%;display: inline;vertical-align: top;" value="<?= $value->eway_bill; ?>" required>
                          <input type="date" id="eway_bill_date" name="eway_bill_date[]" placeholder="Eway Date" value="<?= $value->eway_bill_date; ?>" class="form-control" onfocus="(this.type='date')" style="width:19%;display: inline;vertical-align: top;" required>
                          <input type="date" id="eway_bill_expire" value="<?= $value->eway_bill_expire; ?>" name="eway_bill_expire[]" class="form-control" placeholder="Eway Expire" onfocus="(this.type='date')" style="width:20%;display: inline;vertical-align: top;" required>
                                                            </td>
                                                        <?php if($kee != 1) { ?><td><button class='remove-btn' onclick='removeRow(this)'><i class="bi bi-trash"></i></button></td>
                                                            <?php } ?>
                                                        </tr>
                                                <?php  //break;
                                ...
                                <div class="col-md-5">
                                    <table class="table table-address mb-0 border-end" style="border-color:#000 !important">
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="vehical_number" id="vehical_number" value="<?= $booking->vehical_number ?>" class="form-control" required />
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="submit" class="btn btn-primary btn-sm" form="yourFormId" value="Submit" />
                                        ...
                                        <button type="button" class="btn btn-warning ms-2 d-none">Modify</button>
                                        <a href="<?= base_url('company/booking-link-vehical') ?>" class="btn btn-primary ms-2 ">back</a>
                                    </div>
                                </div>
                            </div>
...
let appendheading =`<th style="background-color: #00297a;" ><h5 style="color:white;">Booking Fields</h5></th>`;
    ...
    $.ajax({
            ...
            success: function(data) {
                 res = JSON.parse(data);
               console.log(res.split_data,'get-split-bill-data');
///////////
...
append_split_table += `<td>
        <table class="table table-address table-pad mb-0">
            ...
            <tr>
                <td class="text-bold"><input type="number" name="rto_fine[]" class="form-control"  value="`+((res.split_data[0][i] && res.split_data[0][i]['rto_fine'] != undefined) ? res.split_data[0][i]['rto_fine'] : '') +`" onchange="validateBookingAmount(this,'rto_fine[]')" style="width: 65%;" required></td>
            </tr>
            <tr>
                <td class="text-bold"><input type="number" name="advance_pay[]" class="form-control"  value="`+((res.split_data[0][i] && res.split_data[0][i]['advance_pay'] != undefined) ? res.split_data[0][i]['advance_pay'] : '') +`" onchange="validateBookingAmount(this,'advance_pay[]')" style="width:65%;" required></td>
            </tr>
            <tr>
                <td class="text-bold"><input type="number" name="statical_charge[]" class="form-control" value="`+((res.split_data[0][i] && res.split_data[0][i]['statical_charge'] != undefined) ? res.split_data[0][i]['statical_charge'] : '') +`" onchange="validateBookingAmount(this,'statical_charge[]')" style="width: 65%;" required></td>
            </tr>
            <tr>
                <td class="text-bold"><input type="number" name="detention_charge_loading[]" class="form-control"  value="`+((res.split_data[0][i] && res.split_data[0][i]['detention_charge_loading'] != undefined) ? res.split_data[0][i]['detention_charge_loading'] : '') +`" onchange="validateBookingAmount(this,'detention_charge_loading[]')" style="width:65%;" required></td>
            </tr>
            <tr>
                <td class="text-bold"><input type="number" name="detention_charge_unloading[]" class="form-control"  value="`+((res.split_data[0][i] && res.split_data[0][i]['detention_charge_unloading'] != undefined) ? res.split_data[0][i]['detention_charge_unloading'] : '') +`" onchange="validateBookingAmount(this,'detention_charge_unloading[]')" style="width: 65%;" required></td>
            </tr>
        </table>
    </td>`;
...
$(document).ready(function() {
    ...
    /////
    $(document).on("click", ".addConsignNumber", function() {
    // Find the closest .consignorr_idn element relative to the clicked .addConsignNumber button
    var $closestConsignorr = $(this).closest('tr').find('.consignorr_idn');
    
    // Retrieve the values of .consign_consignor_id and .consign_consignee_id inputs within the same parent table
    ...
    if(consignor_id == ''  || consignee_id ==''){
        consignor_id=$(this).closest('tr').find('.consignorr_idn').val();
        var tr = $(this).closest('tr');
        var consignee_select = tr.find('select[name="consignee_id[]"]');
        var consignee_id = consignee_select.val();
    }
    // Set the values to the .consign_consignor_id and .consign_consignee_id inputs within the same parent table
    ...
    // Set the values to the .consign_consignor_id and .consign_consignee_id inputs within the same row
    $closestConsignorr.closest('tr').find('.consign_consignor_id').val(consignor_id);
    $closestConsignorr.closest('tr').find('.consign_consignee_id').val(consignee_id);
});
    /////
   ...
   $("select[name='consignee_id[]']").each(function() {
    ...
    if (selectedValues.indexOf(curr_value) !== -1) {
        $(this).val("");
        alert("Each Consignee must be unique. Please select a different Consignee.");
    } else {
    ...
    $(this).each(function() {
        ...
        var consignor_id = $(this).val(); // Get the value of the current .consignorr_idn
        var $parentTable = $childTable.parents('table'); // Find the parent table of the child table
        $parentTable.find(".consign_consignee_id").val(consignor_id); // Set the value to the .consign_cons table
...
$("#addconsignedetail").click(function() {
                                                ...
                                                <td>
                                                    <table class="table table-address mb-0">
                                                        <tr>
                                                            <td class="text-bold border-end" style="width: 30%;">Name:</td>
                                                            <td>
                                                                <select name="consignee_id[]" class="consignee_idn form-control" style="border: 0px;" required>
                                                                    <option value="">Select Consignee</option>
                                                                    <?php foreach ($consignee as $key => $value) {
                                                                    ?>
                                                                        <option value="<?= $value->id ?>"><?= ucfirst($value->name) . ' (' .$value->nickname.')' .' ( '.$value->mobile . ' )'; ?></option>
                                                        ...
                                                        <tr>
                                                            <td class="text-bold border-end">Address:</td>
                                                            <td class="consignee_address"> </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-bold border-end">GSTN:</td>
                                                            <td class="consignee_gst"></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
    ...
    // $("#vehical_number").keyup(function(e) {
        let vehical_number = $("#vehical_number").val();
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (res.status == 1) {
                        ...
                        $("#vehical_Make").html(`<input type="text" name="vehical_Make" id="make" class="form-control" placeholder="Enter Make" style="text-transform:uppercase;border:0px;"  value='`+result.make+`' />`);
                        $("#vehical_Modal").html(`<input type="text" name="vehical_Modal" id="Modal" class="form-control" placeholder="Enter Modal No" style="text-transform:uppercase;border:0px;" value='`+result.model_number+`'  />`);
                        $("#vehical_colour").html(`<input type="text" name="vehical_colour" id="colour" class="form-control" placeholder="Enter Vehical Colour"  style="border:0px;" value='`+result.color+`'/>`);
                        $("#vehical_chassis_no").html(`<input type="text" name="vehical_chassis_no" id="chassis_no" class="form-control" placeholder="Enter Chassis no"  style="text-transform:uppercase;border:0px;" value='`+result.chassis_number+`'/>`);
                        $("#vehical_engine_no").html(`<input type="text" name="vehical_engine_no" id="engine_no" class="form-control" placeholder="Enter Engine no" style="text-transform:uppercase;border:0px;" value='`+result.engine_number+`'/>`);
                        $("#vehical_tax_token").html(`<input type="text" name="vehical_tax_token" id="tax_token" class="form-control" placeholder="Enter Tax Toke"  style="text-transform:uppercase;border:0px;" value='`+result.tax_token+`'/>`);
                        $("#vehical_road_permit_no").html(`<input type="text" name="vehical_road_permit_no" id="road_permit_no" class="form-control" placeholder="Enter Road Permit Number"  style="text-transform:uppercase;border:0px;" value='`+result.road_permmit+`'/>`);
                        $("#vehical_fitness_validity").html(`<input type="date" name="vehical_fitness_validity" id="fitness_validity" class="form-control"  style="border:0px;" value='`+result.fitness_validity+`'/>`);
                        $("#vehical_insured_from").html(`<input type="text" name="vehical_insured_from" id="insured_from" class="form-control" placeholder="Enter Insured from"  style="border:0px;" value='`+result.insurance_by+`'/>`);
                        $("#vehical_date_of_insurance").html(`<input type="date" name="vehical_date_of_insurance" id="date_of_insurance" class="form-control" placeholder="Enter Date of Insurance"  style="border:0px;" value='`+result.insurance_date+`'/>`);
                        $("#vehical_insured_by").html(`<input type="text" name="vehical_insured_by" id="insured_by" class="form-control" placeholder="Enter insured by"  style="border:0px;" value='`+result.insurance_by+`'/>`);
                        $("#vehical_certificate").html(`<input type="text" name="vehical_certificate" id="certificate" class="form-control" placeholder="Enter Certificate No"  style="text-transform:uppercase;border:0px;" value='`+result.certificate+`'/>`);

                        // $("#vehical_certificate").html(result.certificate);
                        $("#vehical_division_no").html(`<input type="text" name="vehical_division_no" id="division_no" class="form-control" placeholder="Enter Division No"  style="text-transform:uppercase;border:0px;" value='`+result.division_number+`'/>`);


                        $("#vehical_financers_name").html(`<input type="text" name="vehical_financers_name" id="financers_name" class="form-control" placeholder="Enter Financers Name"  style="border:0px;" value='`+result.financed_by+`'/>`);
                        $("#vehical_financers_address").html(`<input type="text" name="vehical_financers_address" id="financers_address" class="form-control" placeholder="Enter Financers Address"  style="border:0px;" value='`+result.make+`'/>`);
                        $("#driver_name").html(`<input type="text" name="driver_name" id="drivername" class="form-control" placeholder="Enter Driver Name *" required style="text-transform:uppercase;border:0px;" value='`+result.driver_name+`'/>`);
                        $("#driver_mobile").html(`<input type="text" name="driver_mobile" id="drivermobile" class="form-control" placeholder="Enter Driver mobile *" required style="border:0px;" minlength="10" maxlength="10" value='`+result.driver_mobile+`'/>`);
                        $("#driver_address").html(`<input type="text" name="driver_address" id="driveraddress" class="form-control" placeholder="Enter Driver Address"  style="border:0px;" value='`+result.driver_address+`'/>`);
                        $("#vehical_owner_name").html(`<input type="text" name="vehical_owner_name" id="vehicalowner_name" class="form-control" placeholder="Enter Owner Name"  style="border:0px;" value='`+result.owner_name+`'/>`);
                        $("#vehical_address").html(`<input type="text" name="vehical_address" id="vehicaladdress" class="form-control" placeholder="Enter Owner Address"  style="border:0px;" value='`+result.owner_address+`'/>`);
                        $("#driving_license").html(`<input type="text" name="driving_license" id="drivinglicense" class="form-control" placeholder="Enter Driving License"  style="text-transform:uppercase;border:0px;" value='`+result.driving_licence_no+`'/>`);
                        $("#license_validity").html(`<input type="date" name="license_validity" id="licensevalidity" class="form-control" placeholder="Enter License Validity"  style="border:0px;" value='`+result.fitness_validity+`'/>`);
                        $("#owner_mobile").html(`<input type="text" name="owner_mobile" id="ownermobile" class="form-control" placeholder="Enter Owner Mobile"  style="border:0px;" minlength="10" maxlength="10"  value='`+result.owner_mobile+`'/>`);
