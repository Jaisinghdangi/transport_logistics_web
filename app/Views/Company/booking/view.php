          ...
          <div class="inside-container-fluid inside-container-right pb-2">
            ...
            <table class="table table-address mb-0">
              ...
              <tr>
                ...
                <td style="text-align: right;padding-right: 70px;"><?= $booking ? $booking->rto_fine : 0; ?></td>
              </tr>
              <tr>
                <td class="text-bold">Advance, if any</td>
                <td style="text-align: right;padding-right: 70px;"><?= $booking ? $booking->advance_pay : 0; ?></td>
              </tr>
              <tr>
                <td class="text-bold">Statical Charge (Rs. 80 for AMS)</td>
                <td style="text-align: right;padding-right: 70px;"><?= $booking ? $booking->statical_charge : 0; ?></td>
              </tr>
              <tr>
                <td class="text-bold">Detention Charges at Loading Point</td>
                <td style="text-align: right;padding-right: 70px;"><?= $booking ? $booking->detention_charge_loading : 0; ?></td>
              </tr>
              <tr>
                <td class="text-bold">Detention Charges at Unloading Point</td>
                <td style="text-align: right;padding-right: 70px;"><?= $booking ? $booking->detention_charge_unloading : 0; ?></td>
              </tr>
              <tr>
                <td class="text-bold">Total Payable</td>
                <td style="text-align: right;padding-right: 70px;"><?= $booking ? $booking->total_payable : 0; ?></td>
              </tr>
              <tr>
                <td class="text-bold">CGST 2.5%</td>
                <td style="text-align: right;padding-right: 70px;"><?= $booking ? $booking->total_cgst : 0; ?></td>
              </tr>
              <tr>
                <td class="text-bold">SGST 2.5%</td>
                <td style="text-align: right;padding-right: 70px;"><?= $booking ? $booking->total_sgst : 0; ?></td>
              </tr>
              <tr>
                <td class="text-bold">IGST 5.5%</td>
                <td style="text-align: right;padding-right: 70px;"><?= $booking ? $booking->total_igst : 0; ?></td>
              </tr>
              <tr>
                <td class="text-bold">Total</td>
                <td style="text-align: right;padding-right: 70px;"><?= $booking ? $booking->net_amount : 0; ?></td>
              </tr>
            ...
            <div class="inside-container-fluid inside-container-left mt-2">
              ...
              <table class="table table-address mb-0">
                ...
                <tr>
                  ...
                  <td><input type="number" id="loading_advice_no" name="loading_advice_no" value="10" style="border: 0px;text-align: right;" readonly disabled/></td>
                </tr>
                <tr>
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                <tr>
                  ...
                  <p><?= count($consign_data)?$consign_data[0]['consign_date']:''; ?></p>
                    <p> 
                    </p> 
                  </td>
                  ...
                  <td>
                    <table class="table table-address mb-0">
                      ...
                      <tr>
                        ...
                        <td><?php if (!empty($consignor_details)) {
                              echo ucfirst($result->consinor_address);
                            } ?></td>
                      </tr>
                      <tr>
                  ...
                  <td>
                    <table class="table table-address mb-0">
                      <tr>
                        <td class="text-bold border-end" style="width: 30%;">Name:</td>
                        <td>
                          <?= $consignee ? strtoupper($consignee->name) : ''; ?>
                        </td>
                      </tr>
                      <tr>
                        <td class="text-bold border-end">Address:</td>
                        <td id="consignee_address">
                          <?= $consignee ? strtoupper($consignee->address_1) : ''; ?>,<?= $consignee ? $consignee->pin_code : ''; ?></td>
                      </tr>
                      <tr>
                        <td class="text-bold border-end">GSTN:</td>
                ...
                <?php foreach ($consign_data as $consign) { 
                       ?>
                <tr>  
                  <td><?= $consign['consignment_number']  ?></td><td colspan="2" ><?= $consign['service_description'] ?></td>
                </tr>
                <?php } ?>
              </tbody>
            </table>
