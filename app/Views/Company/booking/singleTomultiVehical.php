    ...
    <div style="background-color:#fff;">
        ...
        <body>
            <div class="app-content">
                <form action="<?= base_url(); ?>save-SingleToMultiVehical" method="POST" enctype="multipart/form-data" id="yourFormId">
                                                        ...
                                                        <table class="table table-address mb-0">
                                                            <tr>
                                                                ...
                                                                <td><?php if (!empty($consignor_details)) {
                                                                      ...
                                                                      <input type="hidden" name="consignorr_id" class="consignorr_idn" value="<?=$consignor_details->id; ?>"></td>
                                                            </tr>
                                                            <tr>
...
$(document).ready(function() {
    ...
    /////
    $(document).on("click", ".addConsignNumber", function() {
    var $closestConsignorr = $(this).closest('tr').find('.consignee_idn');
    
    var consignor_id = $('.consignorr_idn').val();
    ...
    $('.consign_consignor_id').val(consignor_id);
