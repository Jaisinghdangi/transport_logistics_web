    ...
    <div style="background-color:#fff;">
        ...
        <body>
            <div class="app-content">
                <form action="<?= base_url(); ?>save-multipointVehical" method="POST" enctype="multipart/form-data" id="yourFormId">
                    ...
                    <div class="container-fluid mx-0">
                        <div class="container-main py-1">
                            ...
                            <div class="row pl-5 pr-0">
                                ...
                                <div class="col-sm-5 text-right pl-0" id="refreshcontenor">
...
append_split_table += `<td>
    ...
    $(document).ready(function() {
        let consign_number = `<tr><td><div class="input-container">
                          ...
                          <td colspan="2" ><textarea rows="1" cols="3" name="service_description[]" id="service_description" class="form-control" placeholder="Enter DESCRIPTION OF GOODS/SERVICES" style="width:40%;display: inline;"></textarea>
...
$(document).on("change", ".consignorr_idn", function() {
    ...
    $(document).on("change", ".consignee_idn", function(){
        var val=$(this).val();
        console.log(val, 'target value new');
    ...
    var $table = $selectedOption.closest('.table-address');
        $.ajax({
            ...
            success: function(data) {
                ...
                if (result.status == 1) {
                    let consignee = result.result;
                $table.find(".consignee_gst").html(consignee.gst_number);
                $table.find(".consignee_address").html(consignee.delivery_address);
                }
                console.log(result, 'responce');
            },
        });
