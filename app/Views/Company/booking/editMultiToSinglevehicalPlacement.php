    ...
    <div style="background-color:#fff;">
        ...
        <body>
            <div class="app-content">
                <form action="<?= base_url('edit-MultiToSingleVehical/'.$updateid) ?>" method="POST" enctype="multipart/form-data" id="yourFormId">
...
$(document).ready(function() {
    ...
    // On page load
    $(this).each(function() {
        var $childTable = $(this).closest('table'); 
        var consignor_id = $(this).val(); 
        var $parentTable = $childTable.parents('table'); 
        $parentTable.find(".consign_consignor_id").val(consignor_id); 
