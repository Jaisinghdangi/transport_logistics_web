    ...
    <div style="background-color:#fff;">
        ...
        <body>
            <div class="app-content">
                <form action="<?= base_url('edit-SingleToMultiVehical/'.$updateid) ?>" method="POST" enctype="multipart/form-data" id="yourFormId">
...
<?php  }  ?>
                    ...
                    <tfoot <?php if($key1 == '0'){ ?>id="consign_numbers"<?php } if($key1 != '0'){ ?>class="consign_numbers"<?php } ?> >
                          ...
                          <input type="date" id="eway_bill_expire" value="<?= $value->eway_bill_expire; ?>" name="eway_bill_expire[]" class="form-control" placeholder="Eway Expire" onfocus="(this.type='date')" style="width:20%;display: inline;vertical-align: top;" required>
                                                          ...
                                                          <?php if($kee != 1){ ?> </td><td><button class='remove-btn' onclick='removeRow(this)'><i class="bi bi-trash"></i></button></td>
                                                            <?php  } ?>
                                                        </tr>
                                                <?php  //break;
...
append_split_table += `<td>
    ...
    $(document).on("click", ".addConsignNumber", function() {
        ...
        let consign_number = `<tr><td><div class="input-container">
                          ...
                          <input type="text" id="eway_bill" name="eway_bill[]" class="form-control" placeholder="Eway Bill" style="width:19%;display: inline;vertical-align: top;" required>
                          <input type="text" id="eway_bill_date" name="eway_bill_date[]" onfocus="(this.type='date')" placeholder="Eway Date" class="form-control placeholder-shown" style="width:19%;display: inline;vertical-align: top;" required>
                          <input type="text" id="eway_bill_expire" name="eway_bill_expire[]" class="form-control" placeholder="Eway Expire" onfocus="(this.type='date')" style="width:20%;display: inline;vertical-align: top;" required>
                          </td><td><button class='remove-btn' onclick='removeRow(this)'><i class="bi bi-trash"></i></button></td></tr>`;
        // $(".consign_numbers").append(consign_number);
        $table.find(".consign_numbers").append(consign_number);
