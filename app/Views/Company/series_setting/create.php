                        ...
                        <form method="POST">
                            <div class="card-body"> 
                                ...
                                <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4"> 
                                 ...
                                 <input type="text" name="prefix" id="prefix" placeholder="enter Prefix ..."  class="form-control" required>
                                    </div>

                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4"> 
                                        <label for="start_point" class="form-label">Start Point<span class="text-danger">*</span></label>
                                 <input type="text" name="start_point" id="start_point"  placeholder="enter Start Point ..." class="form-control" required>
                                    </div>
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4"> 
                                        <label for="symbl" class="form-label">Symbol<span class="text-danger">*</span></label>
                                 <input type="text" name="symbl" id="symbl"  placeholder="enter Symbol ..." class="form-control" required>
                                    </div>
                                    <input type="hidden" name="comp_id" value="<?= session()->get('CompId');?>" id="comp_id" class="form-control form-control-sm"/>
                                    <!-- <input type="hidden" value="<?//= print_r(session()->get());?>"> -->
                                </div>
