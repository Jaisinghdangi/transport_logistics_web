                            ...
                            <div class="card-body"> 
                                ...
                                <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4"> 
                                        ...
                                        <select name="series_types" id="series_types" class="form-control" required >
                                            <?php if(isset($SeriesType)): ?>
                                                ...
                                                <?php foreach($SeriesType as $Series_val): ?>
                                                    <option value="<?= $Series_val->id ?>"
                                                     <?=($Series_val->id == $terms->voucher_id) ? 'selected' : ''?> ><?= $Series_val->name ?></option>
                                                <?php endforeach ?>
                                            <?php endif; ?>
                                        </select>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12 col-xxl-12"> 
                                        ...
                                        <textarea id="editor" name="editor_content"><?= $terms->description; ?></textarea>
                                    </div>
...
<script>
  $(document).on("change", "#series_types", function() {
        ...
        var terms = <?php echo json_encode($termVoucher); ?>;
