                            ...
                            <div class="card-body"> 
                                ...
                                <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4"> 
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4"> 
                                        ...
                                        <input type="color" name="bg_color" id="bg_color" required class="form-control">
                                    </div>
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4"> 
                                        <label for="text_color" class="form-label">Text Color<span class="text-danger">*</span></label>
                                        <input type="color" name="text_color" id="text_color" required class="form-control">
                                    </div>
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4"> 
                                        <label for="text_font" class="form-label">Text Font<span class="text-danger">*</span></label>
                                        <input type="text" name="text_font" id="text_font" required class="form-control" placeholder="enter define or varified text font">
                                    </div>
...
<?= $this->section('js'); ?>   
    ...
    $(document).on("change", "#print_type", function() {
        ...
        var terms = <?php echo json_encode($printstyle); ?>;
        for (var i = 0; i < terms.length; i++) {
            // console.log(terms[i].print_type);
