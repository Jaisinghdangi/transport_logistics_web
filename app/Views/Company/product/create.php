                            ...
                            <div class="card-body"> 
                                <div class="row"> 
                                    ...
                                    <div class="col-md-8 col-sm-8 col-lg-8 col-xl-8 col-xxl-8">
                                        ...
                                        <input type="text" name="description" value="<?= set_value('description'); ?>" id="description" class="form-control form-control-sm" placeholder="Product Description" autocomplete="off" required=""/>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4 mt-2">
                                        ...
                                        <input type="text" name="mrp" onkeyup="update_price()" onchange="update_price()" value="<?= set_value('mrp'); ?>" id="mrp" class="form-control form-control-sm" placeholder="Mrp" autocomplete="off"  required=""/>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4 mt-2">
                                        ...
                                        <input type="discount" onkeyup="update_price()" onchange="update_price()" name="discount" value="<?= set_value('discount'); ?>" id="discount" class="form-control form-control-sm" placeholder="Discount" autocomplete="off" />
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4 mt-2">
                                        ...
                                        <input type="text" name="price" value="<?= set_value('price'); ?>" id="price" class="form-control form-control-sm" placeholder="Price" autocomplete="off" readonly />
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4 mt-2">
                                        ...
                                        <select name="tax" id="tax" required class="form-control form-control-sm">
                                            ...
                                            <?php foreach ($taxes as $tax_key => $tax_val):?>
                                                <option value="<?= $tax_val->id ?>" <?= set_select('tax', $tax_val->id); ?> ><?= $tax_val->name ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                        <?php if (array_key_exists('price', $errors)) : ?>
                                            <div class="text-danger"> <?= $errors['price'];  ?></div>
