...
<main class="app-main">
    <div class="app-content-header">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0">Create Consignee</h3>
                </div>
                        ...
                        <form method="POST">
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4"> 
                                        ...
                                        <!-- <input type="text" name="consignee_code" value="<?//= set_value('consignee_code',create_consignee_code()); ?>" id="consignee_code" class="form-control form-control-sm" autocomplete="off" required="" readonly /> -->
                                        <input type="text" name="consignee_code" value="<?= $code_prepix->first_prefix.$code_prepix->second_prefix; ?>" id="consignee_code" class="form-control form-control-sm" autocomplete="off" required="" readonly />
                                        <input type="hidden" name="second_prefix" value="<?= $code_prepix->second_prefix; ?>" id="first_prefix" />
                                        ...
                                        <select name="consignee_type" id="consignee_type" class="form-control" required >
                                            <?php if(isset($business_types)): ?>
                                                ...
                                                <?php foreach($business_types as $buss_val): ?>
                                                    <option value="<?= $buss_val->id ?>" <?= set_value('consignee_type')==$buss_val->id?'selected':''; ?> ><?= $buss_val->name ?></option>
                                                <?php endforeach ?>
                                            <?php endif; ?>
                                        </select>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4"> 
                                        ...
                                        <input type="text" name="name" value="<?= set_value('name'); ?>" id="name" class="form-control form-control-sm" placeholder="Consignee Name" autocomplete="off" required="" />
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4"> 
                                        ...
                                        <input type="email" name="email" value="<?= set_value('email'); ?>" id="email" class="form-control form-control-sm" placeholder="Consignee Email" autocomplete="off" required="" />
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <input type="text" name="mobile" value="<?= set_value('mobile'); ?>" id="mobile" minlength="10" maxlength="10" class="form-control form-control-sm" placeholder="Consignee Mobile" minlength="10" autocomplete="off" required="" />
                                        <?php if(array_key_exists('mobile', $errors)): ?>  
                                            <div class="text-danger"> <?= $errors['mobile'];  ?></div>
                                        <?php endif; ?> 
                                    </div>
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        <label for="alternate_mobile" class="form-label">Alternete Mobile </label>
                                        <input type="text" name="alternate_mobile" value="<?= set_value('alternate_mobile'); ?>" id="alternate_mobile" minlength="10" maxlength="10" class="form-control form-control-sm" placeholder="Alternet Mobile" minlength="10" autocomplete="off" />
                                ...
                                <div class="row"> 
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4"> 
                                        ...
                                        <input type="text" name="pan_number" value="<?= set_value('pan_number'); ?>" id="pan_number"  minlength="10" maxlength="10"  class="form-control form-control-sm" placeholder="Pan Number" autocomplete="off" />
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4 d-none"> 
                                        ...
                                        <input type="text" name="ies_number" value="<?= set_value('ies_number'); ?>" id="ies_number" class="form-control form-control-sm" placeholder="IES Number" autocomplete="off" />
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4"> 
                                        ...
                                        <input type="link" name="company_website" value="<?= set_value('company_website'); ?>" id="company_website" class="form-control form-control-sm" placeholder="Consignee Website" autocomplete="off" />
                                ...
                                <h4>Bank Details</h4>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4"> 
                                        ...
                                        <input type="text" name="ifsc_code" value="<?= set_value('ifsc_code'); ?>" id="ifsc_code" class="form-control form-control-sm" placeholder="IFSC Code" minlength="11" maxlength="11" autocomplete="off" />
