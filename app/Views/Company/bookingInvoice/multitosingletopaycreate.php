          ...
          <table class="table table-address mb-0">
            <?php if ($booking_type == 'To Pay') { ?>
              <tr>
                <td class="text-bold">Name:</td>
                <td>
                  <?= strtoupper(getConsinorName($value1->consignor_id)) ?></td>
              </tr>
              <tr>
                <td class="text-bold">Address:</td>

                <td>
                  <?= strtoupper(get_consinor_address($value1->consignor_id)) ?>
                </td>
              </tr>
              <tr>
                <td class="text-bold">GSTIN:</td>
                <td><?= getConsinorGST($value1->consignor_id) ;?></td>
              </tr>
            <?php } else{  ?>
