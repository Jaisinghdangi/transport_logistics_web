  ...
  <div class="mx-0">
    ...
    <div id="print-wrapper">
      <table class="my-table">
                ...
                <td style="width:50%;border:0px;padding: 0;">
                    <table style="border:0px">
                      ...
                      <tr>
                        ...
                        <td style="border-right:0px;"><span><?= $consignee_details ? strtoupper($consignee_details->StateName) : ''; ?> </span></td>
                      </tr>
                    </table>
                </td>
              </tr>
        ...
        <tr>
          <td style="border:0px;padding: 4px 0 0 0;">
            <table style="border:0px;">
              <tr>
                <td style="width:48%;border:0px; padding:0px;">
                  <table style="border:0px;">
                    <tr>
                      <td colspan="2" style="background-color: #00297a; border-left:0px;">
                    ...
                    <tr>
                        <td class="text-bold" style="border-left:0px;">Name:</td>
                        <td><?= strtoupper($consignor_details->name) ?></td>
                      </tr>
                      <tr>
                        <td class="text-bold" style="border-left:0px;">Address:</td>
                        <td><?= strtoupper($result->consinor_address) ?></td>
                      </tr>
                      <tr>
                        <td class="text-bold" style="border-left:0px;border-bottom:0px">GSTIN:</td>
                        <td style="border-bottom:0px"><?php if($consignor_details->gst_number!=''){ echo $consignor_details->gst_number;$billing_customer_gst=1; }  ?></td>
                      </tr>
                      ...
                      <tr>
                        <td class="text-bold" style="border-left:0px;border-bottom:0px">GSTIN:</td>
                        <td style="border-bottom:0px"><?php if($consignee->gst_number!=''){ echo $consignee->gst_number;$billing_customer_gst=1;  }  ?></td>
                      </tr>
                    <?php } ?>
                  </table>
                </td>
                ...
                <td style="width:48%;border:0px;padding:0px;">
                  <table style="border:0px;">
                      <tr>
                        ...
                        <h5 style="color:#fff; font-size:16px;border-right:0px;"><?php if ($booking_type == 'To Pay') {
                            echo "Consignor";
                          } else {
                            echo "Consignee";
                          } ?> Details</h5>
                      ...
                      <?php if ($booking_type == 'To Pay') { ?>
                        ...
                        <tr>
                          ...
                          <td style="border-right:0px; border-bottom:0px"><?= $consignor_details->gst_number ?></td>
                        </tr>
                      <?php } else if ($booking_type == 'Paid') {  ?>
                        ...
                        <tr>
                          <td class="text-bold" style="border-bottom:0px">GSTIN:</td>
                          <td style="border-right:0px;border-bottom:0px"><?= $consignee->gst_number ?></td>
                        </tr>
                      <?php } ?>
                    </table>
                </td>
        ...
        <tr>
          ...
          <table class="table detail-table mb-0">
            ...
            <tr>
                <td colspan="3" rowspan="5" style="border-width:1px !important; padding:0;border-left:0px">
                  <table style="width:40%; height:auto; border:0px">
                    <tr>
                      <td style="border-width:1px !important;border-left:0px !important; border-top:0px !important">Total Freight</td>
                      <td style="border-width:1px !important;border-top:0px !important"><?= $booking ? indian_rupee($booking->booking_amount) : '0.00'; ?></td>
                    </tr>
                    <tr>
                ...
                <td style="text-align:right;border-width:1px !important;border-right:0px !important"><?= indian_rupee($total_amount) ?></td>
            </tr>
            <tr>
