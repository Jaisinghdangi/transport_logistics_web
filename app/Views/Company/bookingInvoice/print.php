  ...
  <div class="mx-0"> 
    <div id="print-wrapper">
      ...
      <table class="my-table">
        ...
        <tr>
          <td style="border:0px;padding-right:0;">
                ...
                <td style="width:50%;border:0px;padding: 0;">
                    <table style="border:0px">
                      <tr>
                        ...
                        <td style="background: #ea7935;color: #fff;font-weight: bold; border-right:0px;"><span class="invoice-no"><?= $invoice->invoice_number ?></span></td>
                      </tr>
                      <tr>
                        <td style="border:0px; font-weight:700;text-align:right">INVOICE DATE.</td>
                        <td style="border-right:0px;"><span class="invoice-no"><?= dispalyDate($invoice->invoice_date) ?></span></td>
                      </tr>
                      <tr>
                        <td style="border:0px; font-weight:700;text-align:right">QUOTATION NO.</td>
                        <td style="border-right:0px;"><span><?= $result->quotation_number ?></span></td>
                      </tr>
                      <tr>
                        <td style="border:0px; font-weight:700;text-align:right">ENQUIRY DATE</td>
                        <td style="border-right:0px;"><span><?= dispalyDate($result->quotation_date) ?></span></td>
                      </tr>
                      <tr>
                        <td style="border:0px; font-weight:700;text-align:right">FROM</td>
                        <td style="border-right:0px;"><span><?= $result ? strtoupper($result->state_name) : ''; ?> </span></td>
                      </tr>
                      <tr>
                        <td style="border:0px; font-weight:700;text-align:right">TO</td>
                        <td style="border-right:0px;"><span><?= $consignee_details ? strtoupper($consignee_details->District) : ''; ?> </span></td>
                      </tr>
                      <tr>
                        ...
                        <td style="border-right:0px;"><span>  
                          <?php  
                            if ($booking_type == 'Paid') {
                             echo strtoupper($consignee_details->StateName); 
                          } else if ($booking_type == 'To Pay') {
                             echo $state = get_title('pincodes', ['id' => $result->delivery_address_id], 'StateName');
                          }   ?>
                        </span></td>
                      </tr>
                    </table>
        ...
        <tr>
          <td style="border:0px;padding: 4px 0 10px 0;">
            <table style="border:0px;">
              <tr>
                <td style="width:48%;border:0px; padding:0px;">
                  <table style="border-left:0px;">
                    <tr>
                      <td colspan="2" style="background-color: #00297a; border-left:0px; verticle-align:top;">
                      <h5 style="color: #fff;font-size:16px;text-align:center;" >Billing Customer & <?php if ($booking_type == 'Paid') {
                                      echo "Consignor";
                                    } else {
                                      echo "Consignee";
                                    } ?> Details</h5>
                     ...
                     <?php $consinee_address_data = get_consinee_address_saprate($consignee->id); ?>
                    <?php if ($booking_type == 'Paid') { ?>
                    <tr>
                        <td class="text-bold" style="border:0px;">Name:</td>
                        <td style="border:0px;"><?= strtoupper($consignor_details->name) ?></td>
                      </tr>
                      <tr>
                        <td class="text-bold" style="border:0px;vertical-align: top;">Address:</td>
                        <td style="border:0px;"><?= strtoupper($consignor_address_data['address1']) ?>,<br>
                        <?= strtoupper($consignor_address_data['address2']) ?>,<br>
                        <?= strtoupper($consignor_address_data['address3']) ?> 
                        </td>
                      </tr>
                      <tr>
                        <td class="text-bold" style="border:0px">GSTIN:</td>
                        <td style="border:0px"><?php if($consignor_details->gst_number!=''){ echo $consignor_details->gst_number;$billing_customer_gst=1; }  ?></td>
                      </tr>
                      ...
                      <tr>
                        <td class="text-bold" style="border:0px;vertical-align: top;">Address:</td>
                        <td style="border:0px;">
                          <?= strtoupper($consinee_address_data['address1']) ?>,<br>
                          <?= strtoupper($consinee_address_data['address2']) ?>,<br>
                          <?= strtoupper($consinee_address_data['address3']) ?>
                        </td>
                      </tr>
                      <tr>
                        <td class="text-bold" style="border:0px;">GSTIN:</td>
                        <td style="border:0px"><?php if($consignee->gst_number!=''){ echo $consignee->gst_number;$billing_customer_gst=1;  }  ?></td>
                      </tr>
                    <?php } ?>
                  </table>
                </td>
                ...
                <td style="width:48%;border:0px;padding:0px;">
                  <table style="border-right:0px;">
                      <tr>
                        ...
                        <h5 style="color:#fff; font-size:16px;border-right:0px;text-align:center;"><?php if ($booking_type == 'To Pay') {
                            echo "Consignor";
                          } else {
                            echo "Consignee";
                          } ?> Details</h5>
                      ...
                      <?php if ($booking_type == 'To Pay') { ?>
                        ...
                        <tr>
                          ...
                          <td style="border:0px;border: none !important;">
                             <?= strtoupper($consinee_address_data['address1']) ?>,<br>
                          <?= strtoupper($consinee_address_data['address2']) ?>,<br>
                          <?= strtoupper($consinee_address_data['address3']) ?>
                          </td>
                        ...
                        <tr>
                          <td class="text-bold" style="border:0px">GSTIN:</td>
                          <td style="border-right:0px; border:0px"><?= $consignor_details->gst_number ?></td>
                        </tr>
                      <?php } else if ($booking_type == 'Paid') {  ?>
                        ...
                        <tr>
                          ...
                          <td style="border:0px;">
                            <?= strtoupper($consignor_address_data['address1']) ?>,<br>
                        <?= strtoupper($consignor_address_data['address2']) ?>,<br>
                        <?= strtoupper($consignor_address_data['address3']) ?>
                          </td>
                        </tr>
                        <tr>
                          <td class="text-bold" style="border:0px">GSTIN:</td>
                          <td style="border-right:0px;border:0px;"><?= $consignee->gst_number ?></td>
                        </tr>
                      <?php } ?>
                    </table>
                </td>
        ...
        <tr>
          ...
          <table class="table detail-table mb-0">
            <thead >
              ...
              <th class="w-70px" style="border-color: #00297a;border-bottom: 0;">CONSGT DATE</th>
              <th class="w-70px" style="border-bottom: 0;">CONSGT NO.</th>
              <th class="w-280px" style="border-bottom: 0;">DESCRIPTION OF GOODS/SERVICES</th>
              <th class="w-60px" style="border-bottom: 0;">TYPES OF VEHICLE</th>
              <th class="w-80px" style="border-color: #00297a;border-bottom: 0;">AMOUNT</th>
              </tr>
            </thead>
            ...
            <tr>
              ...
              <td>Open Truck</td>
              <td class="text-right" style="border-right:0px"><?= indian_rupee($booking->booking_amount) ?></td>
            </tr>
            <?php foreach ($consign_data as $key => $consign_value) { ?>
              <tr>
                <td style="border-left:0px"><?php if ($key == 0) {
            ...
            <?php if ($booking->rto_fine > 0) { ?>
              <tr  >
                ...
                <td></td>
                <td class="text-right" style="border-right:0px"> <?= $booking ? indian_rupee($booking->rto_fine) : '0.00'; ?></td>
              </tr>
            <?php } ?>
            ...
            <?php if ($booking->detention_charge_loading > 0) { ?>
              <tr >
                ...
                <td></td>
                <td class="text-right" style="border-right:0px"> <?= $booking ? indian_rupee($booking->detention_charge_loading) : '0.00'; ?></td>
              </tr>
            <?php } ?>
            <?php if ($booking->detention_charge_unloading > 0) { ?>
              <tr >
                ...
                <td></td>
                <td class="text-right" style="border-right:0px"> <?= $booking ? indian_rupee($booking->detention_charge_unloading) : '0.00'; ?></td>
              </tr>
            <?php } ?>
              ...
              <tr >
                ...
                <td></td>
                <td class="text-right" style="border-right:0px"> <?= $booking ? indian_rupee($booking->statical_charge) : '0.00'; ?></td>
              </tr>
            <?php } ?>
            ...
            <tr>
                <td style="border-width:1px !important;border-left:0px !important;">Total Freight</td>
                <td style="border-width:1px !important;"><?= $booking ? indian_rupee($booking->booking_amount) : '0.00'; ?></td>
                <td style="border-top-width:1px !important;"></td>
                <td style="border-width:1px !important;background: #00297a;color:#fff;"  >TOTAL PAYABLE</td>
                <td style="text-align:right;border-width:1px !important;border-bottom:0px !important;background: #00297a;color:#fff; border-color: #00297a;"><?= indian_rupee($total_amount) ?></td>
            </tr>
            <tr>
                <td style="border-width:1px !important;border-left:0px !important;">Advance Paid</td>
                ...
                <td style="text-align:right;border-width:1px !important;border-right:0px !important"><?= indian_rupee($invoice->total_cgst) ?></td>
            </tr>
            <tr>
              <td style="border-width:1px !important;border-left:0px !important;">Balance</td>
                ...
                <td style="text-align:right;border-width:1px !important;border-right:0px !important"><?= indian_rupee($invoice->total_sgst) ?></td>
            </tr>
            <tr>
              <td colspan="3" rowspan="2" style="border-width:1px !important; padding:0;border-left:0px; border-top:0px;"></td>
                <td style="border-width:1px !important">IGST @5%</td>
                <td style="text-align:right;border-width:1px !important;border-right:0px !important"><?= indian_rupee($invoice->total_igst) ?></td>
            </tr>
            <tr>
                <td style="border-width:1px !important">TOTAL</td>
                <td style="text-align:right;border-width:1px !important;border-right:0px !important"><?= indian_rupee($invoice->total_amount) ?></td>
            </tr>
          </table>
          </td>
        </tr>
        <tr>
          <td style="padding:0px; border-top:0px;">
            <table style="border:0px;">
              <tr>
                <td style="width:50%;border:0px; padding-left:0px;">
                  <p class="bg-color font-small text-left px-1 mb-1">
                    <b>Payable (Amount in Words)</b>: <?= $invoice->amount_words; ?>
                  </p>

                  <?php if($billing_customer_gst==1){ ?>

                    <p class="mb-0 font-small text-left px-1 bg-orange">
                  ...
                  <?php $total_amount = $booking->booking_amount + $booking->detention_charge_unloading + $booking->detention_charge_loading + $booking->statical_charge + $booking->rto_fine; ?>
                  <?php $net_amount = $booking->total_cgst + $booking->total_sgst + $booking->total_igst + $total_amount;  ?>
                  <p class="mb-0 ps-1">Bank Account Information : <span></span></p>
                    <p class="mb-0 ps-1">
                      Account Name :
                ...
                <td style="width:50%;border:0px; padding-right:0px">
                  <p class="mb-0 font-small text-left px-1 bg-color ml-2">
        ...
        <tr>
          <td style="text-align:right;position: relative;">
            ...
            <div style="width:80px; height:80px; border:1px solid #000; position:absolute; top:5px"></div>
        ...
        <tr>
          ...
          <td style="text-align:center; color:#fff;background-color:#00297a;font-size:12px !important; font-weight:bold">Terms and Conditions</td>
        <tr>
          <td style="border:0px">
            <ul class="text-left conditions mb-0" style="padding: 0px 0 0px 0px;">
