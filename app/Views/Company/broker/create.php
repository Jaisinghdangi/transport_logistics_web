                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4"> 
                                        ...
                                        <!-- <input type="text" name="broker_code" value="<?//= create_broker_code(); ?>" id="broker_code" class="form-control form-control-sm" autocomplete="off" required="" readonly /> -->

                                        <input type="text" name="broker_code" value="<?=$code_prepix->first_prefix.$code_prepix->second_prefix; ?>" id="broker_code" class="form-control form-control-sm" autocomplete="off" required="" readonly />
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4"> 
                                        ...
                                        <select name="broker_type" id="broker_type" class="form-control" Company Type>
                                            <?php if(isset($business_types)): ?>
                                                <option value="">Company Type</option>
                                                <?php foreach($business_types as $buss_val): ?>
                                                    <option value="<?= $buss_val->id ?>" <?= set_value('broker_type') == $buss_val->id ? 'selected' : '' ?> ><?= $buss_val->name ?></option>
                                                <?php endforeach ?>
                                            <?php endif; ?>
                                        </select>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <input type="text" name="name" value="<?= set_value('name'); ?>" id="name" class="form-control form-control-sm" placeholder="Broker Name" autocomplete="off" required="" /> 
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <input type="text" name="mobile" value="<?= set_value('mobile'); ?>" id="mobile" class="form-control form-control-sm" placeholder="Mobile" autocomplete="off" required=""  minlength="10" maxlength="10"/>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <input type="text" name="alternet_mobile" value="<?= set_value('alternet_mobile'); ?>" id="alternet_mobile" class="form-control form-control-sm" placeholder="Alternet Mobile" minlength="10" maxlength="10" autocomplete="off" />
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <select name="state" data="<?= set_value('state') ?>" id="state" class="form-control" required>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <select name="district" data="<?= set_value('district') ?>" id="district" class="form-control" required>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4"> 
                                        ...
                                        <input type="text" name="pan_number" value="<?= set_value('pan_number'); ?>" id="pan_number" class="form-control form-control-sm pan_number" placeholder="Pan Number" autocomplete="off" minlength="10" maxlength="10" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4"> 
                                        ...
                                        <input type="text" name="contact_person_mobile" value="<?= set_value('contact_person_mobile'); ?>" id="contact_person_mobile" class="form-control form-control-sm" placeholder="Contact Person Mobile" autocomplete="off" maxlength="10" minlength="10" />
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4"> 
                                        ...
                                        <input type="link" name="company_website" value="<?= set_value('company_website'); ?>" id="company_website" class="form-control form-control-sm" placeholder="Broker Website" autocomplete="off" />
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4"> 
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <input type="radio" name="tds_status" value="1" <?= set_value('tds_status') == 1 ? 'checked' : ''; ?> class="" autocomplete="off" required/> Yes
                                            </div>
                                            <div class="col-6">
                                                <input type="radio" name="tds_status" value="0" <?= set_value('tds_status') == 0 ? 'checked' : ''; ?> class="" autocomplete="off" required/> No
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <h4>Bank Details</h4>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4"> 
                                        ...
                                        <input type="text" name="ac_number" value="<?= set_value('ac_number'); ?>" id="ac_number" class="form-control form-control-sm" placeholder="A/c Number" autocomplete="off" minlength="15" maxlength="15" />
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xxl-4"> 
                                        ...
                                        <input type="text" name="ifsc_code" value="<?= set_value('ifsc_code'); ?>" id="ifsc_code" class="form-control form-control-sm" placeholder="IFSC code" autocomplete="off" minlength="11" maxlength="11" />
