...
class RoleHasPermissionController extends BaseController
{
    ...
    public function index()
    {
        ...
        $data['roles'] = $role->orderBy('id', 'DESC')->where('delete_status',0)->where('comp_id', NULL)->get()->getResult(); 
        return view('Logistics/Role-has-permission/index', $data);
    }
    ...
    public function edit($id){
        ...
        $data['title'] = 'Roles';
        $data['permissions'] = $permissions->where('parent_id',0)->where('comp_id', NULL)->get()->getResult();
        ...
        return view('Logistics/Role-has-permission/edit', $data);
    }
    ...
    public function update($id){
        ...
        return redirect()->to(base_url('admin/role-has-permission')); 
    }
}
