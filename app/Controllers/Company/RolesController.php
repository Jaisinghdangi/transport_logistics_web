...
class RolesController extends BaseController
{
    ...
    public function index()
    {
        $model = new Role();
        $data['title'] = 'Roles';
        $data['roles'] = $model->orderBy('id', 'DESC')->where(['delete_status'=>0, 'id !='=>1,'comp_id' => session()->get('CompId')])->get()->getResult(); 
        return view('Company/Logistics/Roles/index', $data);
    }

    public function create(){
        $data = ['title' => 'Add New Role'];
        return view('Company/Logistics/Roles/create', $data);
    }
    ...
    public function store(){
        ...
        if (!$this->validation->withRequest($this->request)->run()) {  
            ...
            return redirect()->to(base_url('company/roles')); 
        }
    }
    ...
    public function edit($id){
        ...
        return view('Company/Logistics/Roles/edit', $data);
    }
